...
## 
## Basically this is a simplified version of https://github.com/jsk-ros-pkg/jsk_travis/blob/master/.travis.yml with additional comments for maintainability.
## Author: Isaac I. Y. Saito (TORK)


set -x

echo "In common_travis/travis.sh";
